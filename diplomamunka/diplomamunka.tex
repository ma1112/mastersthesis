...
A táblázat értékei alapján objektíven is megállapítható, hogy az általam bevezetett új képfelismerő algoritmusok és a számolások során a hibák figyelembevételével kapott eredményekkel jobb minőségű kép rekonstruálható, mint az eddig használt algoritmussal. 


Figyelemre méltó változás ezen túl a futási idő csökkenése. A párhuzamos feldolgozás miatt az általam használt, több számolást igénylő algoritmusok is hamarabb futnak le, mint a kísérleti algoritmus kódja. A futási idők \aref{tab:futasiidogeom}.~táblázatban láthatóak.
...
Ugyancsak javíthatna a geometriai kalibráció minőségén egy pontos geometriai fantom, vagy fantom sorozat megtervezése és a kalibrációs mérés általános, robusztus protokolljának megtervezése.
